...
❗️ Replace `FS-Olexander` with your GitHub username and copy the links to the `Pull Request` description:

- [DEMO LINK](https://FS-Olexander.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://FS-Olexander.github.io/layout_product-cards/report/html_report/)
